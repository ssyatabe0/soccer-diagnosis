...
function nameOf(item: { full_name?: string | null; parent_name?: string | null; child_name?: string | null; customer_full_name?: string | null; customer_parent_name?: string | null; customer_child_name?: string | null }) { return item.full_name || item.parent_name || item.child_name || item.customer_full_name || item.customer_parent_name || item.customer_child_name || 'LINE' }
